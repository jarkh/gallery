#
# Module manifest for module 'PowerShellUniversal.ActiveDirectory.Scripts'
#
...
@{
    ...
    GUID              = 'fc42777a-39ab-4a08-95ae-584fa4acd471'
    ...
    Description       = 'Active Directory scripts for PowerShell Universal.'
    ...
    PrivateData       = @{
        ...
        PSData = @{
            ...
            Tags        = @('script', 'ActiveDirectory', "PowerShellUniversal")
